...
const GoogleFormService = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      {formSubmitted ? (
        ...
        <iframe 
          src="https://docs.google.com/forms/d/e/1FAIpQLSd0tNfX3bDUNfyAJTgbA-Atvz0ZH6s2eb1JpMFOnfWXD37x6g/viewform?embedded=true" 
          width="80%" 
          height="85vh" 
          frameBorder="0" 
          marginHeight="0" 
