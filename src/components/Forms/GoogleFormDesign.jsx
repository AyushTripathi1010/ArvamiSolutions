...
const GoogleFormDesign = ({ isOpen, onClose }) => {
    ...
    return (
        ...
        >
            {formSubmitted ? (
                ...
                <iframe
                    src="https://docs.google.com/forms/d/e/1FAIpQLSfjYD95iN18QLsPEL3xAXXtg4XK5GKe9sFSgKG3aaVWj6n1pQ/viewform?embedded=true"
                    width="80%"
                    height="85vh"
                    frameBorder="0"
                    marginHeight="0"
...
export default GoogleFormDesign;