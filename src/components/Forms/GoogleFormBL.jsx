...
const GoogleFormBL = ({ isOpen, onClose }) => {
    ...
    return (
        ...
        >
            {formSubmitted ? (
                ...
                <iframe
                    src="https://docs.google.com/forms/d/e/1FAIpQLSes64uCZ8ejWUQZE_3a-6UJti0ipZgGEmzgeh-LJyjyd2PWSg/viewform?embedded=true"
                    width="80%"
                    height="85vh"
                    frameBorder="0"
                    marginHeight="0"
